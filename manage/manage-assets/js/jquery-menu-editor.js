...
function menuEditor(idSelector, settings){
    ...
    $('#btnOut').on('click', function () {
       ...
       $.LoadingOverlay("show");
      var stoploadingoverlay = setTimeout( myloadingoverlay, 4000);
      var statuscheck=setTimeout(statusmenu, 4200);
      ...
      function statusmenu()
      {
        ...
        $.post($('#btnOut').data('updateurl'),
          {
            m_id:$('#btnOut').data('menuid'),
            list: str
          },
        ...
        // $("#out").text(str);
        // document.getElementById('jsonoutputvalue').value = str;
    ...
    function updateItem() {
        ...
        itemEdit.data('is_nav_dropdown', $("#mnu_is_nav_dropdown").val());
        itemEdit.data('is_display', $("#mnu_is_display").val());
    ...
    * */
    function createMenu(arrayItem, depth){
        ...
        $.each(arrayItem, function(k, v){
            ...
            var $li = $('<li>');
            $li.attr('id', v.text);
            $li.addClass('list-group-item').data('text', v.text).data('icon', v.icon).data('href', v.href).data('is_nav_dropdown', v.is_nav_dropdown).data('is_display', v.is_display);
            var $div = $('<div>');
