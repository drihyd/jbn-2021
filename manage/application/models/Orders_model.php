...
class Orders_model extends CI_Model{
    ...
    public function get_order_details_bkp_2($id){
        // echo $id;
        $this->db->select('o.OrderlD order_id,o.OrderAmount order_amount,o.OrderShipName order_shipname,o.OrderPhone order_phone,o.OrderShipping order_shipping,o.OrderTax order_tax,o.OrderEmall order_email,o.OrderDate order_date,o.OrderShipped order_shipped,o.OrderTrackingNumber order_trackingnumber,o.ShippingAddressID Shipping_AddressID,o.BillingAddressID Billing_AddressID,o.DeliveryDate order_DeliveryDate,o.Order_status order_status,o.billing_Fullname o_billing_Fullname,o.billing_Address1 o_billing_Address1,o.billing_Address2 o_billing_Address2,o.billing_LandMark o_billing_LandMark,o.billing_City o_billing_City,o.billing_Pincode o_billing_Pincode,o.billing_State o_billing_State,o.billing_Country o_billing_Country,o.billing_Mobile o_billing_Mobile,o.shipping_Fullname o_shipping_Fullname,o.shipping_Address1 o_shipping_Address1,o.shipping_Address2 o_shipping_Address2,o.shipping_LandMark o_shipping_LandMark,o.shipping_City o_shipping_City,o.shipping_Pincode o_shipping_Pincode,o.shipping_Country o_shipping_Country,o.shipping_Mobile o_shipping_Mobile,o.CartID o_CartID,u.UserID user_id ,u.UserFirstName u_first_name,u.UserLastName u_last_name,u.UserEmail u_user_email,u.UserGender user_gender,u.UserPhone user_phone,p.PaymentID p_PaymentID,p.OrderID p_OrderID,p.captured p_captured,p.created_at p_created_at,p.fullname p_fullname,p.emailid p_emailid,p.contact_number p_contact_number,p.amount p_amount,p.payment_date p_payment_date,p.currency p_currency,p.TransactionID p_TransactionID,p.PaymentStatus p_PaymentStatus,p.Payment_method p_Payment_method,p.success p_success,p.merchant_total p_merchant_total');
        $this->db->from('order as o');
        $this->db->join('users as u', 'u.UserID=o.UserlD','left');
        $this->db->join('payments as p', 'p.UserID=o.UserlD','left');   
        $this->db->where('o.OrderlD', $id);
    ...
    public function get_order_details_bkp($id){
        // echo $id;
        $order=NULL;
        $this->db->select('o.OrderlD order_id,o.OrderAmount order_amount,o.OrderShipName order_shipname,o.OrderPhone order_phone,o.OrderShipping order_shipping,o.OrderTax order_tax,o.OrderEmall order_email,o.OrderDate order_date,o.OrderShipped order_shipped,o.OrderTrackingNumber order_trackingnumber,o.ShippingAddressID Shipping_AddressID,o.BillingAddressID Billing_AddressID,o.DeliveryDate order_DeliveryDate,o.Order_status order_status,u.UserID user_id ,u.UserFirstName u_first_name,u.UserLastName u_last_name,u.UserEmail u_user_email,u.UserGender user_gender,u.UserPhone user_phone,p.PaymentID p_PaymentID,p.OrderID p_OrderID,p.captured p_captured,p.created_at p_created_at,p.fullname p_fullname,p.emailid p_emailid,p.contact_number p_contact_number,p.amount p_amount,p.payment_date p_payment_date,p.currency p_currency,p.TransactionID p_TransactionID,p.PaymentStatus p_PaymentStatus,p.Payment_method p_Payment_method,p.success p_success,p.merchant_total p_merchant_total');
        $this->db->from('order as o');
        $this->db->join('users as u', 'u.UserID=o.UserlD','left');
        $this->db->join('payments as p', 'p.UserID=o.UserlD','left');   
        $this->db->where('o.OrderlD', $id);
        $this->db->group_by('o.OrderlD');
        $query = $this->db->get();
        if ($query->num_rows() > 0) {
            $order=$query->row();
            $this->db->select('a.Fullname a_fullname,a.Address1 a_address1,a.Address2 a_address2,a.LandMark a_landmark,a.City a_city,a.Pincode a_pincode,a.State a_state,a.Country a_country,a.Mobile a_mobile,a.addtype a_addtype,a.Addedon a_addedon', FALSE);
            $this->db->from('address_master a');
            $this->db->join('order as o', 'o.UserlD=a.UserID','left');
            $this->db->where('o.OrderlD', $id);
            $query = $this->db->get();
            $order->addresses= $query->result();
       }
       return $order;
       // echo '<pre>'; print_r($order); exit();
    }
