...
<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="tabbable-line">
          <ul class="nav nav-tabs ">
            ...
            <li>
              <a href="<?php echo base_url()?>orders/today">
              Today Orders</a>
            </li>
            <li class="active">
              <a href="<?php echo base_url()?>orders/month">
              Monthly Orders</a>
            </li>
            <li>
              <a href="<?php echo base_url()?>orders/from_to">
              From -To Orders</a>
            </li>
          </ul>
        </div>
...
<div class="col-md-12 col-sm-12 col-xs-12">
 ...
 <strong><span class="glyphicon glyphicon-ok"></span>   <?php echo $this->session->flashdata('success'); ?></strong>
  ...
  <?php } ?>
                    <table id="order_ajax" class="table table-striped table-bordered" style="width:100%">
                      <thead>
