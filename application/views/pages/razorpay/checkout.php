...
echo $surl = $surl;
$furl = $furl;        
echo $key_id = RAZOR_KEY_ID;
$currency_code = $currency_code;            
$total = 100*1; 
$amount = 100*1;
$merchant_order_id = 63;
    ...
    <div class="row">   
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">                        
            <table class="table table-bordered table-hover table-striped print-table order-table" style="font-size:11px;">
                ...
                <tbody>                    
                    <tr>
                        <td class="text-left"><img width="80" height="80" src=""></td>
                        <td class="text-left"><?php print "venkt";?></td>
                        <td class="text-left"><?php print 1;?></td>
                        <td class="text-right">1</td>
                        <td class="text-right"><?php print 1;?></td>                        
                    </tr>                        
                </tbody>                        
            </table>
        </div>
