      			...
      			<div class="col-md-12 col-lg-10 col-xl-10">
      				<div class="card">
      					<div class="card-body">
      						<div class="row">
      							<div class="col-sm-12">
      								<img src="<?php echo base_url('assets/img/anaya-logo-new.jpg')?>" alt="logo" class="img-responsive" width="120" style="margin: auto; margin-bottom: 15px;">
      							</div>
      						</div>
      						<h2 class="text-center text-black">TAX INVOICE</h2>
				      		<div class="row">
				      			<div class="col-sm-5">
				      				<div class="wrapper">
				      				...
				      				<table class="table table-bordered">
				      						...
				      						<tbody>
				      							<?php foreach ($order->items as $value) { ?>
				      								...
				      								<td><?php echo $value->p_Gross_weight?></td>
				      								<td><?php echo $value->d_ProductPrice?></td>
				      								<td><?php echo $value->d_Amount?></td>
				      							</tr> -->
				      							<td><?php echo $value->d_ProductSKU?></td>
				      								<td><?php echo $value->d_ProductName?></td>
				      								<td><?php echo $value->d_Quantity?></td>
...
// foreach($order->items as $sum_value){ 
	$sum_1 = $s_1+ $value->d_Amount; ?>
				      				...
				      				<div class="float-right">
				      					<a href="<?php echo base_url("myaccount")?>" class="btn btn-brand btn-sm">Back</a>
