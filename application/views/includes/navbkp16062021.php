...
<header id="main-header">
  <div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-white" id="main-nav">
      ...
      <a href="<?php echo base_url()?>" class="navbar-brand"><img src="<?php echo base_url()?>assets/img/anaya-logo-new.jpg" class="logo" alt="Brand Logo"></a>
...
$loopcount=1;
          ...
          <li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle" href="<?php echo $sub_menu_2->m_item_url;?>" data-toggle="dropdown"><strong><?php echo $menu->m_item_name;?></strong></a>
            <?php } else { ?>
            <a class="nav-link" href="<?php echo $sub_menu_2->m_item_url;?>"><strong><?php echo $menu->m_item_name;?></strong></a>
            <?php } ?>
  <?php if($menu->is_nav_dropdown=="Yes" || $menu->is_nav_dropdown=="yes") { ?>
...
if(isset($_SESSION['anaya_user_data']) && $_SESSION['anaya_user_data'] != '') {  ?>
    <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle arrow-right" data-toggle="dropdown">Welcome to <?php echo ucwords($_SESSION['anaya_user_data']->UserFirstName);?> <?php echo ucwords($_SESSION['anaya_user_data']->UserLastName);?><i class="fas fa-user"></i><!-- <?php if(isset($email1[0])) echo ucfirst($email1[0]) ?> --></a>
            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-shadow" role="menu">
              ...
              <li class="nav-item px-3 py-2">
                <a href="<?php echo base_url()?>myaccount" class="nav-link p-0">My Account</a>
              </li>
              <li class="nav-item px-3 py-2">
          ...
          <li class="nav-item d-none d-lg-flex d-xl-block ml-2">
            <span class="nav-link">
              <a href="<?php echo base_url();?>cart/wishlist" class="cart-icon"><i class="fas fa-heart"></i>
                <span class="cart-count"><?php echo $count_wishlists;?></span></a>
            </span>
          </li>
          <li class="nav-item d-none d-lg-flex d-xl-block">
            <span class="nav-link">
              <a href="<?php echo base_url();?>cart" class="cart-icon"><i class="fas fa-shopping-cart"></i>
                <span class="cart-count"><?php echo $cart_items;?></span></a>
            </span>
          </li>
        </ul>
      </div>
