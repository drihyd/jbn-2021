...
{	
	...
	{
		$this->db->select('p.screw_type,p.cad_availability,p.mould_availability,p.certificate_number,p.Polish_Details,p.Provision_for_opening,p.No_of_pieces,p.ProductID,p.SKU,p.CategoryID,p.product_type ,p.Gender,p.Sub_CategorylD,p.Productlive,p.Name,p.lmage,p.Stock,p.Price,p.MRP_Price,p.Net_weight,p.Material_type, p.slug, p.is_make_an_order') 
