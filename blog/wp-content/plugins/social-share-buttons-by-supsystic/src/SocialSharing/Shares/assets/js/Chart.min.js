...
(function() {
    ...
    e.instances = {}, e.Type = function(t, i, s) {
        ...
        draw: function() {
            if (this.display) {
                var t = this.ctx;
                t.beginPath(), t.arc(this.x, this.y, Math.abs(this.radius), 0, 2 * Math.PI), t.closePath(), t.strokeStyle = this.strokeColor, t.lineWidth = this.strokeWidth, t.fillStyle = this.fillColor, t.fill(), t.stroke()
            }
        }
        ...
        draw: function(t) {
            var i = this.ctx;
            i.beginPath(), i.arc(this.x, this.y, Math.abs(this.outerRadius), this.startAngle, this.endAngle), i.arc(this.x, this.y, Math.abs(this.innerRadius), this.endAngle, this.startAngle, !0), i.closePath(), i.strokeStyle = this.strokeColor, i.lineWidth = this.strokeWidth, i.fillStyle = this.fillColor, i.fill(), i.lineJoin = "bevel", this.showStroke && i.stroke()
        }
                ...
                if (n(this.yLabels, function(i, e) {
                        if (e > 0) {
                            var s, n = e * (this.drawingArea / this.steps),
                                o = this.yCenter - n;
                            if (this.lineWidth > 0)
                                if (t.strokeStyle = this.lineColor, t.lineWidth = this.lineWidth, this.lineArc) t.beginPath(), t.arc(this.xCenter, this.yCenter, Math.abs(n), 0, 2 * Math.PI), t.closePath(), t.stroke();
                                else {
                                    t.beginPath();
