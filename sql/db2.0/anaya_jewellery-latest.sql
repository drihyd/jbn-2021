...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 18, 2021 at 12:12 PM
...
(1, 'jayaraju@deepredink.com', 'e10adc3949ba59abbe56e057f20f883e', 'Jayaraju', 'vangapandu', 1, '2020-08-13 08:55:18', '::1', '9700334319', 'vijayawada', 1, 'Active', '2021-03-17 11:38:17'),
...
(6, 5, 1, '', 'Kia11', 53115.2, 53115.2, 'NPT 37', 1, 0, '', 53115.2, 53115.2, '', '', 0);
...
(5, '20210317132539', '3', 53115.2, 1500, 2000, 'Jayaraju Vangapandu ', '', 0, 0, 'jayaraju@deepredink.com', '2021-03-17 07:55:39', 0, '', 'delivery_at_address', '0000-00-00 00:00:00', 'on Hold', 'jayaraju', '102', '', '', 'vijayawada', '520004', 'AP', 'India', '9700334319', 'jayaraju', '102', '', '', 'vijayawada', '520004', 'AP', 'India', '9700334319');
...
CREATE TABLE `order` (
  ...
  `Delivery_Mode` varchar(20) NOT NULL,
  `DeliveryDate` datetime NOT NULL,
  `Order_status` enum('placed','confirmed','processing','dispatched','shipped to','delivered','cancelled','cancelled-Refund pending','Cancelled-Refunded','on Hold') NOT NULL DEFAULT 'placed',
  `billing_Fullname` varchar(100) NOT NULL,
  `billing_Address1` varchar(150) NOT NULL,
  `billing_Address2` varchar(150) NOT NULL,
  `billing_LandMark` varchar(100) NOT NULL,
